...
discovery. Time-dependent attributes must be provided at case level. The
pipeline adds two features:
...
The \texttt{@@} prefix shows that these are case-level attributes
