...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    also has two specialised areas: an empty-container depot (called
...
the truck enters the terminal. Consequently, the number of planned stops,
...
subsequently realised durations or completion outcomes. In particular,
...
variables as case attributes therefore does not leak the simulated future
...
\texttt{xes\_files/s6\_test.xes}. The CSV representation serves as the
primary pipeline format; XES enables compatibility with pm4py, ProM
