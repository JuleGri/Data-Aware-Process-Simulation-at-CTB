...
The Petri net that ProSiT uses as the authoritative control-flow skeleton is
constructed from the observed training variants as a raw sequential prefix
trie, following the definition in Chapter~\ref{chp:background}. This is not a
classical process-discovery abstraction: it stores the observed activity
